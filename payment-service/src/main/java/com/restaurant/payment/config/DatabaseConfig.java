...
/**
 * Database configuration with read/write splitting support for Payment Service.
 */
@Configuration
@EnableJpaRepositories(
    basePackages = "com.restaurant.payment.infrastructure.repository",
...
public class DatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        em.setPackagesToScan("com.restaurant.payment.infrastructure.eventstore");
